...
namespace Store.Core.Utils.Validators.FluentValidation.Items;
...
public class ItemValidator : AbstractValidator<Item>
{
    ...
    private class ItemIdValidator : AbstractValidator<Guid>
    {
    ...
    private class UserIdValidator : AbstractValidator<Guid>
    {
    ...
    private class TitleValidator : AbstractValidator<string>
    {
    ...
    private class DescriptionValidator : AbstractValidator<string?>
    {
    ...
    private class PriceValidator : AbstractValidator<decimal>
    {
    ...
    private class QuantityValidator : AbstractValidator<int>
    {
    ...
    private class CreatedAtValidator : AbstractValidator<Item>
    {
    ...
    private class UpdatedAtValidator : AbstractValidator<Item>
    {
